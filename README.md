...
1. How could this be used in iPhones without an app
2. 
...
<img src='https://github.com/ciscohern/Canvas/blob/master/Canvas%20Demo.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
